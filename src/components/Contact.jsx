...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const mailtoLink = `mailto:mdyasir4145@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(formData.message)}`;
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="flex-1">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <motion.button 
                ...
                className="px-6 py-3 rounded-md hover:opacity-80 duration-300 font-semibold"
          ...
          <div className="md:w-1/3">
            <h3 style={{ color: '#ffffff' }} className="text-2xl font-bold mb-6">
              Connect With Me
            </h3>
